...
/**
 * Mapper simplificado para convertir entre entidades de dominio y entidades JPA
 */
@Component
public class CitaMapperSimple {
    ...
    public CitaEntity toEntity(Cita cita) {
        ...
        // Observaciones
        cita.getObservaciones().ifPresent(entity::setObservaciones);
